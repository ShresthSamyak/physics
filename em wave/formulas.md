...
\frac{\epsilon\mu}{2}
\left[
\sqrt{1 + \left(\frac{\sigma}{\epsilon\omega}\right)^2} + 1
\right]
}
$$
...
represents the **phase shift between electric and magnetic fields**.
