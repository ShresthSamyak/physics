...
\section{Differential Equation of Simple Harmonic Motion}
...
\item \(\phi\) = Phase constant
\end{itemize}

---

\section{Velocity in Simple Harmonic Motion}
...
\section{Differential Equation of a Simple Pendulum}
...
\section{LC Circuit Oscillation}
...
\[
x = A_1 e^{\left[-\frac{b}{2m} + \sqrt{\left(\frac{b}{2m}\right)^2 - \frac{k}{m}}\right]t}
+
A_2 e^{\left[-\frac{b}{2m} - \sqrt{\left(\frac{b}{2m}\right)^2 - \frac{k}{m}}\right]t}
\]

---

\section{Damped LCR Circuit}
...
A =
\frac{F_0/m}
{\sqrt{(\omega^2 - \omega_0^2)^2
+
\left(\frac{b\omega}{m}\right)^2}}
}
\]
